...
module.exports = function (codigoEstadoHttp, mensaje, codigoErrorInterno) {
  ...
  this.mensaje = mensaje || 'Error inesperado. Por favor toma contacto con el creador de la aplicación';
